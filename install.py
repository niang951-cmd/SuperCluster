#!/usr/bin/env python3
# install.py - Installation SuperCluster en 1 commande
...
print("=" * 60)
print("🚀 SUPERCLUSTER - Installation en 1 commande")
print("=" * 60)
...
# 2. Écrire le fichier requirements.txt
with open("windows/requirements.txt", "w") as f:
    f.write("flask\nflask-socketio\neventlet")

# 3. Écrire la page web HTML (web_index.html)
html_content = """<!DOCTYPE html>
<html>
<head><title>SuperCluster APK</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<style>
body{background:#0d1117;color:#e6edf3;font-family:Arial;display:flex;justify-content:center;align-items:center;height:100vh;margin:0}
.container{text-align:center;max-width:500px;padding:30px;background:#161b22;border-radius:16px;border:1px solid #30363d}
h1{color:#58a6ff;font-size:2rem}
p{color:#8b949e}
.btn{display:inline-block;background:#1f6feb;color:white;padding:14px 30px;border-radius:30px;text-decoration:none;font-weight:bold;font-size:1.1rem}
...
<div class="container">
<h1>🚀 SuperCluster</h1>
<p>Téléchargez l'APK pour rejoindre le cluster.</p>
<a href="/download" class="btn">⬇️ Télécharger APK</a>
<div class="info">Installez l'APK sur vos Android.<br>L'application détecte automatiquement le cluster.</div>
</div>
</body>
</html>"""
with open("windows/web_index.html", "w", encoding="utf-8") as f:
    f.write(html_content)

# 4. Écrire l'application Windows (supercluster_app.py)
...
if __name__ == "__main__":
    ...
    root.mainloop()
'''
with open("windows/supercluster_app.py", "w", encoding="utf-8") as f:
    f.write(app_content)

# 5. Vérifier la présence de l'APK
apk_path = "apk/SuperCluster.apk"
if not os.path.exists(apk_path):
    print("\n⚠️ APK non trouvé dans 'apk/SuperCluster.apk'")
    print("   Vous pouvez le compiler plus tard ou le placer ici.")
    print("   En attendant, le serveur web fonctionne mais l'APK ne sera pas téléchargeable.")
    with open("apk/README.txt", "w") as f:
        f.write("Placez votre SuperCluster.apk ici.\n")
else:
    print(f"\n✅ APK trouvé : {apk_path}")
...
print("\n🚀 Lancement de SuperCluster...")
print("   🌐 Interface web : http://" + get_local_ip() + ":5000")
print("   📱 Téléchargez l'APK depuis la page web.")
print("   💬 Utilisez le chat pour interagir avec l'IA.\n")
subprocess.run([sys.executable, "windows/supercluster_app.py"])
